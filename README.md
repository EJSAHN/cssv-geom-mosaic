...
## Add-on: nearest-neighbor context / provenance annotation (post-hoc)
...
- Header/description table:
  - created from a FASTA containing the accessions present in the analysis (see `addon_01_reference_projection.py`)
